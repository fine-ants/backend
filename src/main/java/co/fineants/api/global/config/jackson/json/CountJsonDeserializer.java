...
public class CountJsonDeserializer extends JsonDeserializer<Count> {
	/**
	 ...
	 */
	@Override
	public Count deserialize(JsonParser parser, DeserializationContext ctx) throws IOException {
