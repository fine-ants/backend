...
class PortfolioHoldingRestControllerTest {
	...
	void readMyPortfolioStocks() throws Exception {
		...
		resultActions
			...
			.andExpect(jsonPath("data.portfolioDetails.currentValuation").value(closeTo(180000, 0.0)))
			.andExpect(jsonPath("data.portfolioDetails.investedAmount").value(closeTo(150000, 0.0)))
			.andExpect(jsonPath("data.portfolioDetails.totalGain").value(closeTo(30000, 0.0)))
			.andExpect(jsonPath("data.portfolioDetails.totalGainRate").value(closeTo(20.0, 0.1)))
			.andExpect(jsonPath("data.portfolioDetails.balance").value(closeTo(850000, 0.0)))
			.andExpect(jsonPath("data.portfolioDetails.annualDividend").value(closeTo(4332, 0.0)))
		...
		resultActions
			...
			.andExpect(jsonPath("data.portfolioHoldings[0].currentValuation").value(closeTo(180000, 0)))
			.andExpect(jsonPath("data.portfolioHoldings[0].currentPrice").value(equalTo(60000)))
			.andExpect(jsonPath("data.portfolioHoldings[0].averageCostPerShare").value(closeTo(50000, 0)))
			...
			.andExpect(jsonPath("data.portfolioHoldings[0].totalGain").value(closeTo(30000, 0)))
			.andExpect(jsonPath("data.portfolioHoldings[0].totalReturnRate").value(closeTo(20.0, 0.1)))
			.andExpect(jsonPath("data.portfolioHoldings[0].annualDividend").value(closeTo(4332, 0)))
	...
	void readMyPortfolioCharts() throws Exception {
		...
		mockMvc.perform(get("/api/portfolio/{portfolioId}/charts", portfolio.getId()))
			...
			.andExpect(jsonPath("data.pieChart[0].valuation").value(closeTo(850000, 0.0)))
			...
			.andExpect(jsonPath("data.pieChart[1].valuation").value(closeTo(180000, 0.0)))
			.andExpect(jsonPath("data.pieChart[1].weight").value(equalTo(17.48)))
			.andExpect(jsonPath("data.pieChart[1].totalGain").value(closeTo(30000, 0.0)))
			...
			.andExpect(jsonPath("data.dividendChart[3].amount").value(closeTo(1083, 0.0)))
			.andExpect(jsonPath("data.dividendChart[4].month").value(equalTo(5)))
			.andExpect(jsonPath("data.dividendChart[4].amount").value(closeTo(1083, 0.0)))
			...
			.andExpect(jsonPath("data.dividendChart[7].amount").value(closeTo(1083, 0.0)))
			...
			.andExpect(jsonPath("data.dividendChart[10].amount").value(closeTo(1083, 0.0)))
